...
EMAIL_ADDRS = ['dfdfdf.dfdf.1985@gmail.com', 'amkolotov@gmail.com']
                                                # gmails which granded with privelages to edit the
                                                # Google spreadsheet after a creating
SOURCE_SPREADSHEET = '1T1KbdgpzDevTnW3-khy0kNXwKRSo-B8mU_NZ7NARrjk' # the origin Google spreadsheet
